...
const handleDeletetTask = async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .json({
        message:
          "task and related task members deleted successfully. To recover, go to the trash page.",
      });
  } catch (error) {
    console.error(error);
...
const handleRestoretask = async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .json({
        message:
          "task and related task members recovered successfully. To view, go to the original page.",
      });
  } catch (error) {
    console.error(error);
    return res.status(500).json({ message: "Server error" });
