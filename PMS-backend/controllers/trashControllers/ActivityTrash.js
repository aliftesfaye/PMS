...
const handleDeleteActivity = async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .json({
        message:
          "Activity and related activity members deleted successfully. To recover, go to the trash page.",
      });
  } catch (error) {
    console.error(error);
...
const handleRestoreActivity = async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .json({
        message:
          "Activity and related activity members recovered successfully. To view, go to the original page.",
      });
  } catch (error) {
    console.error(error);
    return res.status(500).json({ message: "Server error" });
